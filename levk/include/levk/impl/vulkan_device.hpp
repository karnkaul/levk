...
void gfx_render(VulkanDevice& out_device, GraphicsRenderer& out_renderer, Camera const& camera, Extent2D extent, Rgba clear);
...
void gfx_render_mesh(VulkanDevice& out, Mesh const& mesh);
} // namespace levk
